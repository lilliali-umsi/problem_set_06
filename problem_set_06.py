...
with open(source_path, 'r') as file_obj:
    for file_line in file_obj:
        file_lines_list.append(file_line)
...
def transform_a_list_even(list_of_strings):
    ...
    for i in range(0, len(list_of_strings)):
        if i % 2 != 0:
            even_list.append(list_of_strings[i].replace('-', ''))
    return even_list
#print(transform_a_list_even(file_lines_list))
...
def transform_a_list_odd(list_of_strings):
    ...
    for i in range(0, len(list_of_strings)):
        if i % 2 == 0:
            odd_list.append(list_of_strings[i].lower().replace('-', '').replace('...', '').replace('.', '').replace(',', '').replace('!', '').replace('?', ''))
        for string in odd_list:
            string.replace('-', '')
            string.replace("...", '')
            string.replace(",", '')
            string.replace(".", '')
...
#print(transform_a_list_odd(file_lines_list))
...
# Write your code here
transformed_file_lines_list_odd.append(transform_a_list_odd(file_lines_list))
transformed_file_lines_list_even.append(transform_a_list_even(file_lines_list))
